...
namespace DoAn1.Areas.Admin.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public HomeController(UserManager<IdentityUser> userManager, SignInManager<IdentityUser> signInManager/*, RoleManager<IdentityUser> roleManager*/)
        {
        ...
        public async Task<IActionResult> Edit(string email)
        {
            ...
            //ViewData["AllRoles"] = new SelectList(allRoles, "Role");
            var user = await _userManager.FindByEmailAsync(email);
